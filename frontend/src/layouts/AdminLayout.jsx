...
const navItems = [
  ...
  { to: '/admin/barang', label: 'Data Barang', icon: '📦' },
  { to: '/admin/pengguna', label: 'Data Pengguna', icon: '👤' },
  { to: '/admin/laporan', label: 'Laporan Penjualan', icon: '📋' },
  { to: '/admin/riwayat', label: 'Riwayat Transaksi', icon: '🕐' },
  { to: '/admin/kas', label: 'Saldo Kas', icon: '💵' },
]
